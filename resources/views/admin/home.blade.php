    ...
    <div class="lg:ml-64">
        ...
        <div class="p-4">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4 lg:px-0">
                <div class="flex items-center justify-center h-16 lg:h-24 rounded-lg bg-[#8739f9] shadow-sm shadow-slate-400">
                    <div class="w-full flex flex-row justify-between items-center px-4 py-2 lg:px-10">
                        <div class="flex flex-col">
                            ...
                            <h4 class="text-lg lg:text-2xl text-white">{{ @count($users)}}</h4>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-6 h-6 lg:w-12 lg:h-12">
                ...
                <div class="flex items-center justify-center h-16 lg:h-24 rounded-lg bg-[#8739f9] shadow-sm shadow-slate-400">
                    <div class="w-full flex flex-row justify-between items-center px-4 py-2 lg:px-10">
                        <div class="flex flex-col">
                            <p class="text-xs text-white">Jumlah Order</p>
                            <h4 class="text-base lg:text-2xl text-white">34</h4>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-6 h-6 lg:w-12 lg:h-12">
                ...
                <div class="flex items-center justify-center h-16 lg:h-24 rounded-lg bg-[#8739f9] shadow-sm shadow-slate-400">
                    <div class="w-full flex flex-row justify-between items-center px-4 py-2 lg:px-10">
                        <div class="flex flex-col">
                            ...
                            <h4 class="text-base lg:text-2xl text-white">14</h4>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-6 h-6 lg:w-12 lg:h-12">
                ...
                <div class="flex items-center justify-center h-16 lg:h-24 rounded-lg bg-[#8739f9] shadow-sm shadow-slate-400">
                    <div class="w-full flex flex-row justify-between items-center px-4 py-2 lg:px-10">
                        <div class="flex flex-col">
                            <p class="text-xs text-white">Reservation Today</p>
                            <h4 class="text-base lg:text-2xl text-white">4</h4>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-6 h-6 lg:w-12 lg:h-12">
                            <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" />
                            <path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z" />
