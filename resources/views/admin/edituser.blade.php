...
<body class="font-['Montserrat']">
    ...
    <div class="ml-64">
        <x-admin-nav router='admin / edituser' titlepage='Edit Users' photo="{{ URL::to('/assets/profiles/' . $authUser['photo'])}}"></x-admin-nav>
        <div class="px-4">
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="flex items-center justify-center h-24 rounded border bg-slate-200 border-gray-400">
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 flex flex-row space-x-2">
                                <a href="{{ url('/admin/edituser/form/'. $user->id) }}">
                                    @csrf
                                    <button type="submit" class="btn bg-peachy-brown">Edit</button>
                                </a>
