            ...
            <div class="bg-white rounded-lg p-4">
                <form action="/admin/adduser" method="POST">
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="bg-peachy-brown text-slate-800 focus:ring-4 focus:outline-none focus:ring-[#7849d8] font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create User</button>
                    </div>
                </form>
            </div>
        </div>
