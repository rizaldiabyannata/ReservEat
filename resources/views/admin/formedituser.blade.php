                    ...
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        ...
                        <form method="POST" action="{{ '/admin/edituser/form/' . $user->id }}">
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input type="text" id="name" name="name" value="{{ $user->name }}" class="w-full p-2 text-sm text-gray-700" required>
                            </div>
                            <div class="flex flex-wrap mb-6">
                                <label for="email" class="block text-gray-700 text-sm font-bold mb-2">Email:</label>
                                <input type="email" id="email" name="email" value="{{ $user->email }}" class="w-full p-2 text-sm text-gray-700" required>
                            </div>
                            <div class="flex flex-wrap mb-6">
                                <label for="phone" class="block text-gray-700 text-sm font-bold mb-2">Phone:</label>
                                <input type="tel" id="phone" name="phone" value="{{ $user->phone }}" class="w-full p-2 text-sm text-gray-700" required>
                            </div>
                            <div class="flex flex-wrap mb-6">
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input type="password" id="password" name="password" class="w-full p-2 text-sm text-gray-700">
                            </div>
