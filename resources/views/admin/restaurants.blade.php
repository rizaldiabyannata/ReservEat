    ...
    <div class="ml-64">
        <div class="px-2">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="flex items-center justify-center h-24 rounded border border-gray-400 bg-slate-300">
                    <div class="w-full flex flex-row justify-between px-10">
                        <div class="flex flex-col">
                            <p class="text-xs text-black">Jumlah Reservation Today</p>
                            <h4 class="text-2xl text-black">{{@count($reservations)}}</h4>
                        </div>
                ...
                <div class="flex items-center justify-center h-24 rounded border border-gray-400 bg-slate-300">
                    <div class="w-full flex flex-row justify-between px-10">
                        <div class="flex flex-col">
                            ...
                            <h4 class="text-2xl text-black">{{ @count($restaurantsWithRatings)}}</h4>
