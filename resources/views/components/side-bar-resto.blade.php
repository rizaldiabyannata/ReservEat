<aside class="max-w-62.5 bg-slate-100 h-lvh fixed inset-y-0 shadow-md block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 p-0 antialiased transition-transform duration-200 xl:left-0 xl:translate-x-0">
    <div class="h-19.5">
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href='/restaurantadmin/review-customer'>
                    <div class=" mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Customer Review</span>
                </a>
            </li>
            ...
            <li class="mt-0.5 w-full cursor-pointer">
                <form action="/logout" method="post" class="flex items-center p-2 text-slate-500">
                    @csrf
                    <button class="flex flex-row justify-center items-center mx-8 space-x-5" type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H15" />
                        </svg>
                        <span class="flex-1 text-sm ms-3 whitespace-nowrap">Log Out</span>
                    </button>
                </form>
            </li>
        </ul>
