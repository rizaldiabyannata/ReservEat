...
<body class="font-['Montserrat'] bg-gray-100">
    ...
    <div id="carousel" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 md:px-8 lg:px-16">
        <div class="restaurant-card bg-white rounded-lg shadow-md overflow-hidden transform transition-transform hover:-translate-y-2">
            <img src="https://via.placeholder.com/300" alt="Restaurant" class="w-full h-48 object-cover border-b border-gray-200">
            <div class="p-6">
