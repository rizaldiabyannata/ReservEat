    ...
    <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            <div class="flex flex-col md:flex-row">
                <img src="https://via.placeholder.com/600x400" alt="Restaurant Image" class="w-full md:w-1/2 rounded-lg mb-6 md:mb-0 md:mr-6">
                <div>
                ...
                <table class="w-full table-auto">
                    ...
                    <tbody>
                        <tr class="bg-gray-100">
                            <td class="border px-4 py-2"><img src="https://via.placeholder.com/100" alt="Menu Item 1" class="w-16 h-auto"></td>
                        ...
                        <tr>
                            <td class="border px-4 py-2"><img src="https://via.placeholder.com/100" alt="Menu Item 2" class="w-16 h-auto"></td>
                        ...
                        <tr class="bg-gray-100">
                            <td class="border px-4 py-2"><img src="https://via.placeholder.com/100" alt="Menu Item 3" class="w-16 h-auto"></td>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="space-y-4">
                <div class="collapse collapse-arrow bg-base-200">
                    <input type="radio" name="review" id="review1" checked />
