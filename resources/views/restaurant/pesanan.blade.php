...
<head>
    ...
    <link href="../assets/css/nucleo-svg.css" rel="stylesheet" />w
        ...
        <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
          <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
              ...
              <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">Order</li>
            </ol>
            <h6 class="mb-0 font-bold capitalize">Order</h6>
          </nav>
