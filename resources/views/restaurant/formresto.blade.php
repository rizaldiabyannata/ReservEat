...
<body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <form method="POST" action="/restaurantadmin/addmenu" enctype="multipart/form-data">
            @csrf
            <div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
                ...
                <div class="mb-4">
                    ...
                    <input type='file' class="text-gray-500">
                    <p class="text-sm text-gray-500 mt-2">Upload Foto 1:1 atau 3:4. Foto Produk akan digunakan di halaman utama.</p>
                </div>

                <!-- Nama Produk -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Nama menu</label>
                    <input type="text" class="w-full p-2 border border-gray-300 rounded-md" name="name" placeholder="masukan nama menu yang sesuai dengan gambar">
                </div>

                <!-- Kategori -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Kategori</label>
                    <select class="w-full p-2 border border-gray-300 rounded-md" name="category">
                        <option>Pilih kategori</option>
                        <option value="1">Makanan Besar</option>
                ...
                <div class="mb-6">
                    ...
                    <textarea class="w-full p-2 border border-gray-300 rounded-md" rows="5" name="description" placeholder="Deskripsi Produk"></textarea>
                </div>

                <!-- Stock -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Stok</label>
                    <input type="number" class="w-full p-2 border border-gray-300 rounded-md" name="stock" placeholder="Masukan jumlah stok">
                </div>

                <!-- Price -->
                <div class="mb-4">
                    <label class="block text-gray-700 font-bold mb-2">Harga</label>
                    <input type="number" class="w-full p-2 border border-gray-300 rounded-md" name="price" placeholder="Masukan harga produk">
                </div>

                <!-- Tombol -->
                <div class="bg-orange-500 flex w-44 justify-center rounded-md">
                    <button type="submit" class="text-black p-2 rounded-md">Simpan & Tampilkan</button>
                </div>
