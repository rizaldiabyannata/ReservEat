...
<body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
    ...
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
        ...
        <div class="mb-4">
            ...
            <p class="text-sm text-gray-500 mt-2">Size: Max 30MB, resolution should not exceed 1280x1280px. Format: MP4, catatan : optional.</p>
        </div>

        <!-- Nama Produk -->
        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2">Nama menu</label>
            <input type="text" class="w-full p-2 border border-gray-300 rounded-md" placeholder="masukan nama menu yang sesuai dengan gambar">
        </div>
